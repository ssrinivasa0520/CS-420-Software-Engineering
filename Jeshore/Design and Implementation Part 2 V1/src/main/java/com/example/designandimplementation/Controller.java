...
public class Controller{
    ...
    private void droneMenu(){ //On menu click add drone and update list
        ...
        }, 0, 0, 50,50,100,100, Color.BLACK, Color.BLACK));
        xPos = 100;
        yPos = 100;
        updateFarmItemList();
    ...
    private void containerMenu(){ //On menu click add container and update list
        ...
        addItem(new ItemContainer("New_Container", new ArrayList<ItemInfo>(), 0, 0, x,y,50,50, Color.BLACK, Color.BLACK));
    }
    @FXML
    ...
    private void priceSave(){ //Saves value and updates farm list
        ...
        value.accept(new valuesDisplayVisitor(), selection);
    }
    @FXML
