...
public class ItemContainerCommandCenter extends ItemLeaf{
    ...
    int commandCenter;
    //Constructor
    public ItemContainerCommandCenter(String name, int cc, ArrayList<ItemInfo> children, double price, double marketValue, double marketValueAll, double priceAll, double x, double y, double l, double w, Color fC, Color cC){
        this.name = name;
