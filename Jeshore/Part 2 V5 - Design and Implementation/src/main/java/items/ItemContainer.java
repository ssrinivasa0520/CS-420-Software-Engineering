...
public class ItemContainer extends ItemLeaf{
    ...
    //Constructor
    public ItemContainer(String name, ArrayList<ItemInfo> children, double price, double marketValue, double priceAll, double marketValueAll, double x, double y, double l, double w, Color fC, Color cC){
        this.name = name;
